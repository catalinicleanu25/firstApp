...
import ro.db.springboot.domain.Authority;
import ro.db.springboot.domain.PersistentToken;
import ro.db.springboot.domain.User;
import ro.db.springboot.repository.AuthorityRepository;
import ro.db.springboot.repository.PersistentTokenRepository;
...
import ro.db.springboot.web.rest.vm.KeyAndPasswordVM;
import ro.db.springboot.web.rest.vm.ManagedUserVM;
